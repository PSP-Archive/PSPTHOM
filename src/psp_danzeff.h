...
#define  DANZEFF_COPY            3
#define  DANZEFF_DEL             4
#define  DANZEFF_ENTER           5
#define  DANZEFF_STOP            6
#define  DANZEFF_SHIFT_L         7
#define  DANZEFF_SHIFT_R         8
#define  DANZEFF_RETURN          9
#define  DANZEFF_CNT            10
#define  DANZEFF_RAZ            11
#define  DANZEFF_TOP            12
#define  DANZEFF_INS            13
#define  DANZEFF_CAPSLOCK       14
#define  DANZEFF_ACCENT         15
#define  DANZEFF_TAB            16
