...
static inline void mc6846_SetTcr(struct MC6846_PIA *mc6846, int val)
{
    mc6846->tcr=val;
...
static inline void mc6846_SetTmsb(struct MC6846_PIA *mc6846, int val)
{
    mc6846->tmsb=val;
}


static inline void mc6846_SetTlsb(struct MC6846_PIA *mc6846, int val)
{
    mc6846->tlsb=val;
...
static inline int mc6846_tcr(struct MC6846_PIA *mc6846)
{
    return mc6846->tcr;
}


static inline int mc6846_tmsb(struct MC6846_PIA *mc6846)
{
    mc6846->csr&=0xFE;
    MAKE_CSR();
...
static inline int mc6846_tlsb(struct MC6846_PIA *mc6846)
{
    if (mc6846->tcr&1) /* timer disabled */
        return mc6846->tlsb;
    else
...
static inline void mc6846_WriteCommand(struct MC6846_PIA *mc6846, int val)
{
...
static inline void mc6846_SetCP1(struct MC6846_PIA *mc6846, int state)
{
...
static inline void mc6846_WriteData(struct MC6846_PIA *mc6846, int val)
{
